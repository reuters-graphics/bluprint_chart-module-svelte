<nav>
  <svg x="0px" y="0px" width="125.9px" height="30px" viewBox="0 0 125.9 30">
    <pattern
      x="-157.1"
      y="427.8"
      width="69"
    ...
    <g>
      <path
        class="st3"
        d="M51.8,21.3h-2.2c-0.2,0-0.3-0.2-0.4-0.4l-2.6-4.4h-0.4c-0.5,0-2-0.1-2.4-0.1V21c0,0.2-0.1,0.4-0.4,0.4h-1.8
      ...
      <g>
        <path
          class="st4"
          d="M14.9,7.1c-0.2,0.3-0.6,0.3-0.9,0c-0.3-0.2-0.3-0.6,0-0.9c0.2-0.3,0.6-0.3,0.9,0C15.1,6.4,15.1,6.8,14.9,7.1z
        ...
        <path
          class="st4"
          d="M12.3,7.9c-0.2,0.2-0.5,0.2-0.7,0c-0.2-0.2-0.2-0.5,0-0.7C11.7,7,12,7,12.2,7.2C12.4,7.4,12.4,7.7,12.3,7.9z
        ...
        <path
          class="st4"
          d="M22.6,9.5c-0.4,0.4-1,0.4-1.5,0c-0.4-0.4-0.4-1,0-1.5c0.4-0.4,1-0.4,1.5,0C22.9,8.5,23,9.1,22.6,9.5z
